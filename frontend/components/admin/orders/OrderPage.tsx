            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <p className="text-gray-500">{selectedOrder?.address?.firstName} {selectedOrder?.address?.lastName}</p>
                  <p className="text-gray-500">{selectedOrder?.address?.phone}</p>
                  <p className="text-gray-500">street : {selectedOrder?.address?.street}, city : {selectedOrder?.address?.city}</p>
                  <p className="text-gray-500">state : {selectedOrder?.address?.state} , pincode : {selectedOrder?.address?.pincode}</p>
                </div>
                <div>
